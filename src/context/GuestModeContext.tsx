          ...
          <AlertDialogFooter className="flex-col gap-2">
            <div className="flex flex-row gap-2 w-full">
              <AlertDialogAction
                ...
                className="flex-1 h-10 rounded-full text-sm bg-muted-foreground/20 text-muted-foreground hover:bg-muted-foreground/30"
              >
                Log In
              </AlertDialogAction>
              <AlertDialogAction
                onClick={() => goToAuth('signup')}
                className="flex-1 h-10 rounded-full text-sm bg-primary text-primary-foreground hover:bg-primary/90"
              >
                Sign Up
              </AlertDialogAction>
            </div>
