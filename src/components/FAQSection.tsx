...
const faqItems = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'If there\'s an issue with your order, start by messaging the seller through the order chat. You can request a refund directly in the chat within 48 hours of the order being marked as delivered. Once a request is submitted, the seller has 72 hours to approve or decline. If they don\'t respond in time, the refund is issued automatically. If the seller declines, Flea reviews the request and may still issue the refund at our discretion.',
      },
      {
