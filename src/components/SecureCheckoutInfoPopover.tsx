  ...
  <Popover>
    ...
    <PopoverContent className="w-72 p-4 rounded-2xl z-[100]" side="top" align="center" onOpenAutoFocus={(e) => e.preventDefault()}>
      ...
      <p className="text-xs text-muted-foreground leading-relaxed">
        A small fee that helps us provide secure transactions, fraud prevention and marketplace support so you can shop with confidence. Sellers pay no selling fees - just a 2% + $0.50 transaction fee that covers payment processing when an item sells.
      </p>
    </PopoverContent>
  </Popover>
);
