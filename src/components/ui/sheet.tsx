...
>(({ className, ...props }, ref) => {
  ...
  return (
    <SheetPrimitive.Overlay
      className={cn(
        "fixed inset-x-0 bottom-0 top-[calc(-1*env(safe-area-inset-top,0px))] z-[60] bg-foreground/50 data-[state=open]:animate-in data-[state=open]:fade-in-0",
        className,
      )}
      {...props}
      ref={innerRef}
...
const sheetVariants = cva(
  "fixed z-[60] gap-4 bg-background p-6 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
