...
const DrawerFooter = ({
  className,
  ...props
}: React.HTMLAttributes<HTMLDivElement>) => <div className={cn("shrink-0 border-t bg-background px-4 pt-3 pb-[calc(1rem+env(safe-area-inset-bottom))]", className)} {...props} />;
