...
const Block = ({ heading, detail, animation, isAccent, index }: { heading: ReactNode; detail: ReactNode; animation?: ReactNode; isAccent: boolean; index: number; }) => {
  ...
  const extraBottom = index === 2 || index === 4
    ? "pb-[calc(env(safe-area-inset-bottom,0px)+1.75rem)] min-[390px]:pb-[calc(env(safe-area-inset-bottom,0px)+2.25rem)] min-[440px]:pb-[calc(env(safe-area-inset-bottom,0px)+8rem)]"
    : "pb-[calc(env(safe-area-inset-bottom,0px)+1rem)] min-[390px]:pb-[calc(env(safe-area-inset-bottom,0px)+1.5rem)] min-[440px]:pb-[calc(env(safe-area-inset-bottom,0px)+5.5rem)]";
  return (
    <motion.div
      initial={{ y: 28 }}
      animate={{ y: 0 }}
    ...
    >
      <div className="px-8 min-[390px]:px-8 md:px-12 lg:px-16 flex-shrink-0 pt-[calc(env(safe-area-inset-top,0px)+4.25rem)] min-[390px]:pt-[calc(env(safe-area-inset-top,0px)+5rem)] min-[440px]:pt-[calc(env(safe-area-inset-top,0px)+10rem)] md:pt-[calc(env(safe-area-inset-top,0px)+9rem)] lg:pt-[calc(env(safe-area-inset-top,0px)+10rem)]">
