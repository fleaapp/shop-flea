      ...
      <div className="container mx-auto max-w-xl text-center">
        ...
        <motion.div className="flex flex-col sm:flex-row justify-center items-center gap-3 mb-10" initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 0.4 }}>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-navy/40 rounded-xl w-[220px] py-3.5 cursor-not-allowed"
          >
            ...
            <p className="text-flea-cream text-xs font-bold uppercase tracking-wide">App Store · Coming Soon</p>
          </button>
          <button
            type="button"
            disabled
          ...
          >
            ...
            <p className="text-flea-cream text-xs font-bold uppercase tracking-wide">Google Play · Coming Soon</p>
          </button>
        </motion.div>
