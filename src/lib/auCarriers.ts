...
export const AU_CARRIERS: AuCarrier[] = [
  ...
  },
  {
    name: 'StarTrack',
    code: 100530,
    patterns: [/^[A-Z]{2,4}\d{6,12}$/, /^\d{9,16}$/],
    hint: 'StarTrack consignment numbers look like ABCD123456 or 9-16 digits.',
  },
  {
    name: 'CouriersPlease',
    code: 100286,
    patterns: [/^[A-Z]{2,4}\d{6,12}$/, /^\d{8,16}$/],
    hint: 'CouriersPlease numbers look like ABC123456 or 8-16 digits.',
  },
  {
    name: 'TNT',
    code: 100006,
    patterns: [/^\d{9}$/, /^\d{12,15}$/, /^[A-Z]{2}\d{9}[A-Z]{2}$/],
    hint: 'TNT consignment numbers are 9 digits, or GE123456789WW format.',
  },
  {
    name: 'Toll',
    code: 100325,
    patterns: [/^\d{9,15}$/, /^[A-Z]{3,4}\d{6,12}$/],
    hint: 'Toll connote numbers are 9-15 digits, or ABC123456 format.',
  },
  {
    name: 'DHL Express',
    code: 100001,
