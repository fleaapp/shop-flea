...
// Keyboard awareness is handled app-wide by a single implementation mounted
// from <App /> (`useKeyboardInputScroll` -> `@/lib/keyboardAware`). It shifts
// the focused field into view only while the keyboard is up — no padding, no
// reserved footer strip, nothing left behind when the keyboard closes.
