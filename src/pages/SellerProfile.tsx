                ...
                <div className="px-2 max-[393px]:px-1.5 max-[375px]:px-1 pt-3 max-[393px]:pt-1.5 max-[375px]:pt-1.5 pb-1 max-[393px]:pb-0.5 max-[375px]:pb-0.5">
                  <div className="flex items-end justify-between">
                    ...
                    <div className="text-right flex-shrink-0 ml-3 max-[393px]:ml-1.5 max-[375px]:ml-1.5">
                      <p className="text-lg max-[393px]:text-base max-[375px]:text-sm font-bold text-foreground leading-tight">${listing.price}</p>
                      <p className="text-xs max-[393px]:text-[10px] max-[375px]:text-[9px] text-muted-foreground whitespace-nowrap leading-tight">+ ${listing.shipping_price || 0} shipping</p>
                    </div>
                  </div>
                </div>
              </div>
