      ...
      <div className="px-4 space-y-4">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="w-56 rounded-full bg-[hsl(0,0%,55%)] text-white font-bold py-4 text-sm hover:bg-[hsl(0,0%,50%)] transition-colors flex items-center justify-center gap-2"
          >
