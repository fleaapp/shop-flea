...
const Auth = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      if (error) {
        ...
        logError({ title: 'Google sign-in failed (web)', message: error.message, severity: 'error', source: 'auth' });
  ...
  return (
    <div className="auth-screen fixed inset-0 bg-primary flex flex-col overflow-hidden pt-[env(safe-area-inset-top)]">
      ...
      <div className="auth-logo absolute top-[calc(env(safe-area-inset-top,0px)+80px)] max-[375px]:top-[calc(env(safe-area-inset-top,0px)+48px)] left-0 right-0 flex justify-center">
        <img 
          src={fleaLogoAuth} 
          alt="FLEA" 
          width={232}
        ...
        <div className="w-full max-w-[min(260px,85vw)]">
          ...
          <div className="mt-7">
            ...
            <div className="flex justify-center gap-3">
              ...
              {/* Apple sign-in temporarily hidden — Google only for now.
              <button
                type="button"
