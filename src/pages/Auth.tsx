  ...
  return (
    <div className="min-h-screen bg-primary flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10">
        ...
        {/* Tab Toggle */}
        <div className="flex bg-foreground rounded-full p-1 mb-6">
          <button
          ...
          <div className="mt-7">
            ...
            <div className="flex justify-center gap-3">
              <button
                ...
                className="w-10 h-10 rounded-lg bg-foreground flex items-center justify-center hover:bg-foreground/90 transition-colors"
              >
