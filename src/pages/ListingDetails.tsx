    ...
    <div className="min-h-screen bg-background">
      <Drawer open={open} onOpenChange={isOpen => !isOpen && handleClose()} repositionInputs={false}>
        <DrawerContent className="mt-0 flex h-[95svh] max-h-[95svh] flex-col overflow-hidden rounded-t-3xl bg-background">
          ...
          <div data-listing-footer className="left-0 right-0 z-10 flex shrink-0 justify-center gap-3 border-t border-border bg-background px-4 pt-4 pb-[calc(1rem+env(safe-area-inset-bottom))] transition-all duration-200">
            {isRemoved && !isOwner ? (
