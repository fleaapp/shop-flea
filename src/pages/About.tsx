    ...
    <div className="min-h-screen bg-[#DBFBD5] font-sans overflow-hidden">
      ...
      <section className="md:hidden bg-[#dcffd8] relative">
        ...
        <video
          ...
          muted
          playsInline
          className="absolute bottom-0 right-0 w-[55%] rounded-tl-2xl z-[3]"
      ...
      <section className="relative px-6 pt-40 pb-32 hidden md:block">
        ...
        <img src={stickerRecycle} alt="" className="absolute top-6 right-2 w-36 rotate-[10deg] pointer-events-none select-none z-[2]" style={{ clipPath: 'inset(15% 5% 15% 5%)' }} />
        ...
        <img src={stickerOldNew} alt="" className="absolute top-[220px] left-1 w-28 rotate-[-3deg] pointer-events-none select-none z-[1] opacity-90" style={{ clipPath: 'inset(18% 5% 18% 5%)' }} />
        {/* White logo — top right area */}
        <img src={stickerLogo} alt="" className="absolute top-[140px] right-2 w-28 rotate-[-12deg] pointer-events-none select-none z-[1]" style={{ clipPath: 'inset(20% 5% 20% 5%)' }} />
        {/* Yellow — above top-right corner of phone mockup */}
        <img src={stickerSecondhand} alt="" className="absolute top-[60%] right-4 w-32 rotate-[6deg] pointer-events-none select-none z-[2]" style={{ clipPath: 'inset(18% 3% 18% 3%)' }} />

        <div className="relative z-10 max-w-2xl mx-auto text-center">
          <img alt="Flea" className="h-20 mx-auto mb-8" src="/lovable-uploads/8d52d6b9-59c0-490a-97c0-5ffab455f175.jpg" />
          <h1 className="text-5xl font-extrabold leading-tight tracking-tight text-[#423d3d]">
