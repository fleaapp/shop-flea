  ...
  return <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-4 space-y-6">
        {activeTab === 'activity' ? <>
            ...
            {/* Awaiting Shipping */}
            {awaitingShipping.length > 0 && <div>
                <h2 className="mb-3 text-base font-semibold text-foreground">Awaiting shipping</h2>
                <div className="space-y-3">
                  {awaitingShipping.map(sale => <div key={sale.id} className="flex items-center gap-4 rounded-2xl bg-card p-4 card-shadow cursor-pointer">
            ...
            {/* Shipped */}
            {shipped.length > 0 && <div>
                <h2 className="mb-3 text-base font-semibold text-foreground">Shipped</h2>
                <div className="space-y-3">
                  {shipped.map(sale => <div key={sale.id} className="flex items-center gap-4 rounded-2xl bg-card p-4 cursor-pointer">
                      <ProductThumbnail image={sale.productImage} avatar={sale.userAvatar} />
                      <div className="flex-1 min-w-0">
                        <p className="text-sm text-foreground">
                          Sold to <span className="font-semibold">@{sale.username}.</span>
            ...
            {/* Delivered */}
            {delivered.length > 0 && <div>
                <h2 className="mb-3 text-base font-semibold text-foreground">Delivered</h2>
                <div className="space-y-3">
                  {delivered.map(sale => <div key={sale.id} className="flex items-center gap-4 rounded-2xl bg-card p-4 cursor-pointer">
                      <ProductThumbnail image={sale.productImage} avatar={sale.userAvatar} />
                      <div className="flex-1 min-w-0">
                        <p className="text-sm text-foreground">
                          Sold to <span className="font-semibold">@{sale.username}.</span>
